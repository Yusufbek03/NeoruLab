    ...
    <section className="relative bg-bg px-6 lg:px-[60px] pt-[150px] pb-[100px]">
      ...
      <div className="max-w-[760px] mx-auto relative z-10">
        ...
        >
          <Link 
            href="/blog" 
            className="inline-flex items-center gap-2 text-accent-green font-mono text-[12px] mb-10 hover:underline transition-all"
          >
            ← {language === "ru" ? "Назад в блог" : "Blogga qaytish"}
          </Link>
          ...
          <div className="mt-24 pt-10 border-t border-border-dim flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full bg-gradient-to-tr from-accent-green to-accent-green-dark text-black flex items-center justify-center font-bold text-xl">
                N
              </div>
              <div>
                <p className="font-syne font-bold text-white text-[18px] leading-none mb-2">NeoruLab Team</p>
                <p className="text-[13px] text-text-muted font-mono">Digital Agency · {language === 'ru' ? 'Технологии & AI' : 'Texnologiyalar & AI'}</p>
              </div>
            </div>
          </div>
        </motion.div>
