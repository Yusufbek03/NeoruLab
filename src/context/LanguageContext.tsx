...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    newsletterSuccess: "Спасибо за подписку! Мы будем присылать вам только самое полезное.",
    newsletterError: "Некорректный email. Попробуйте еще раз.",
  ...
  uz: {
    ...
    formSuccessTitle: "Ariza yuborildi!",
    formErrorTitle: "Yuborishda xatolik",
    close: "Yopish",
    ...
    newsletterSuccess: "Obuna bo'lganingiz uchun rahmat! Biz sizga eng foydali ma'lumotlarni yuboramiz.",
    newsletterError: "Email noto'g'ri. Qayta urinib ko'ring.",
